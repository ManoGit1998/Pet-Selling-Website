...
@WebServlet("/seller_pet")
@MultipartConfig
public class SellersPet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			PetDetails p = new PetDetails(petname, type, price, category, status, fileName, useremail);
